...
from shared_models.blog import BlogPost
from shared_models.customer import User, UserRoles, Role, Company, CompanyMembers
from shared_models.forum import ForumComment, ForumPost, Thread, ThreadRoles
from shared_models.product import Product
from shared_models.order import Contracts, Orders, OrderHistory, OrderChangeRequest, ShippingAddress, Customer, OrdersList
from shared_models.ticket import TicketComment, TicketForum, Resolution
from shared_models.calendar import Event
from shared_models.public import Home, About
from shared_models.message import Message, Room, UserRoom
from shared_models.job import Job
from shared_models.application import Application, StatusCode


# Define relationships between models

# Company
Company.customer = models.OneToOneField(
    Customer, on_delete=models.CASCADE, related_name='company')
...
User.customer = models.OneToOneField(
    Customer, on_delete=models.CASCADE, related_name='user')
User.tickets = models.ManyToManyField(TicketForum, related_name='user')
User.ticket_comments = models.ManyToManyField(
    TicketComment, related_name='user')
...
# Job
Job.user = models.ForeignKey(
    User, on_delete=models.CASCADE, related_name='job')

# Application
Application.user = models.ForeignKey(
    User, on_delete=models.CASCADE, related_name='application')
Application.job = models.ForeignKey(
...
# Customer
Customer.user = models.OneToOneField(
    User, on_delete=models.CASCADE, related_name='customer')
Customer.company = models.OneToOneField(
...
Customer.shipping_address = models.ManyToManyField(
    ShippingAddress, related_name='customer')

# ShippingAddress
ShippingAddress.customer = models.ForeignKey(
    Customer, on_delete=models.CASCADE, related_name='shipping_address')

# Orders
Orders.user = models.ForeignKey(
    User, on_delete=models.CASCADE, related_name='orders')
Orders.orders_list = models.ManyToManyField(OrdersList, related_name='orders')
Orders.customer = models.ForeignKey(
    Customer, on_delete=models.CASCADE, related_name='orders')
Orders.order_history = models.ManyToManyField(
    OrderHistory, related_name='order')
Orders.order_change_request = models.ManyToManyField(
    OrderChangeRequest, related_name='order')

# OrderChangeRequest
OrderChangeRequest.order = models.ManyToManyField(
    Orders, related_name='order_change_request')
OrderChangeRequest.orders_list = models.ManyToManyField(
    OrdersList, related_name='order_change_request')

# OrdersList
OrdersList.orders = models.ForeignKey(
    Orders, on_delete=models.CASCADE, related_name='orders_list')
OrdersList.order_change_request = models.ForeignKey(
    OrderChangeRequest, on_delete=models.CASCADE, related_name='orders_list')
OrdersList.product = models.ForeignKey(
    Product, on_delete=models.CASCADE, related_name='orders_list')

# OrderHistory
OrderHistory.order = models.ManyToManyField(
    Orders, related_name='order_history')
...
# Message
Message.author = models.ForeignKey(
    User, on_delete=models.CASCADE, related_name='messages')
Message.room = models.ForeignKey(
    Room, on_delete=models.CASCADE, related_name='messages')

# Room
Room.messages = models.ManyToManyField(Message, related_name='room')
Room.members = models.ManyToManyField(
    User, through=UserRoom, related_name='rooms')
